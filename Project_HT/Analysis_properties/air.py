...
def air_a4():
	...
	air_tablea_4 = np.array([ [100 ,  3.5562,    1.032,    71.1 ,   2.00 ,   9.34,    2.54,   0.786],
	...
	air_tablea_4[:,3] = air_tablea_4[:,3] * 10**-7 # correct magnitude of value 
	air_tablea_4[:,4] = air_tablea_4[:,4] * 10**-6 # correct magnitude of value 
	air_tablea_4[:,5] = air_tablea_4[:,5] * 10**-3 # correct magnitude of value 
	air_tablea_4[:,6] = air_tablea_4[:,6] * 10**-6 # correct magnitude of value 
